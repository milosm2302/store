...
export const action = (store) => async ({request}) =>{
  ...
  return redirect("/");
    ...
    const errorMessage = error?.response?.data?.error?.message || 'please check credentials';
...
const Login = () => {
  ...
  <Form method='post' className='card w-96 p-8 bg-base-100 shadow-lg flex flex-xol gap-y-4'>
