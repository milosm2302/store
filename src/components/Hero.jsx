  ...
  return (
    <div className='grid lg:grid-cols-2 gap-24 items-center'>
      <div>
        ...
        <p className='mt-8 max-w-xl text-large leading-8'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate ex enim maiores tempore necessitatibus molestias neque rem asperiores ut. Necessitatibus?</p>
        <div className="mt-10">
